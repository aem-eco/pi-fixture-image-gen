...
# Install the API keys into the pyVenv
install -v -o 1000 -g 1000 -m 666 files/_env_vars.pth "${ROOTFS_DIR}/home/prod/${PY_VENV_NAME}/lib/python3.11/site-packages/_env_vars.pth"
